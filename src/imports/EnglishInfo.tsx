...
function Group2() {
  return (
    <div className="absolute contents left-[695px] top-[1460px]">
      <p className="absolute font-['Rubik:Light',sans-serif] font-light leading-[normal] left-[730px] text-[12px] text-black top-[1463px] whitespace-nowrap">Info@nordicnaw.se</p>
